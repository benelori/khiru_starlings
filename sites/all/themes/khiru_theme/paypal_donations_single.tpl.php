<form action="https://<?php echo variable_get('paypal_donations_service_url', 'www.sandbox.paypal.com'); ?>/cgi-bin/webscr" method="post" target="_blank" class="single-donation-form donation-form">
  ...
  <div>
    <input type="checkbox" name="terms_and_services"><span>
      I agree with the <?php print l(t('terms and services'), file_create_url($variables['terms_and_services_file']), array('attributes' => array('target' => '_blank'))); ?> of this site
      </span>
  </div>
  <a href="#" class="donation-submit-button inactive"><?php echo t($variables['submit_value']); ?></a>
</form>
